...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/slider":11,"./modules/tabs/init-tabs":12,"./modules/video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var initSwipers = function initSwipers() {
  ...
  if (document.querySelector('.coaches__swiper')) {
    coachesSwiper = new _swiper.default('.coaches__swiper', {
      navigation: {
  ...
  if (document.querySelector('.reviews__slider')) {
    reviewsSwiper = new _swiper.default('.reviews__slider', {
      navigation: {
  ...
  return {
    coachesSwiper: coachesSwiper,
    reviewsSwiper: reviewsSwiper
  };
};
exports.initSwipers = initSwipers;

},{"../vendor/swiper":17}],12:[function(require,module,exports){
"use strict";
...
var container = document.querySelector('.gym__video-wrapper');
...
var initVideoPlayer = function initVideoPlayer() {
  if (container !== null) {
    var cover = container.querySelector('img');
